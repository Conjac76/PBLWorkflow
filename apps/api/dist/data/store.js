...
const projects = [{ id: "project_1", name: "PBL Science Unit", createdAt: created }];
const groups = [
...
export const insertGroup = (data) => {
    const item = { id: makeId("group"), createdAt: nowIso(), ...data };
    db.groups.push(item);
    return item;
};
export const insertMilestone = (data) => {
    const item = { id: makeId("milestone"), createdAt: nowIso(), updatedAt: nowIso(), ...data };
...
export const insertArtifact = (data) => {
    const now = nowIso();
...
export const insertCheckIn = (data) => {
    const item = { id: makeId("checkin"), createdAt: nowIso(), updatedAt: nowIso(), ...data };
...
export const insertComment = (data) => {
    const item = { id: makeId("comment"), createdAt: nowIso(), updatedAt: nowIso(), ...data };
...
export const replaceIndicatorsForGroup = (groupId, next) => {
